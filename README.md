...
> - 📦 Balanced **product-level revenue** distribution identified
...
| 1 | Members generate **+18% more revenue** than Non-Members while showing **~3% lower variability**, indicating more stable and predictable purchasing behavior | Reinforce loyalty program investments to stabilize and grow revenue streams |

| 2 | ~80% of total revenue is generated by ~70% of products, indicating a **moderately distributed revenue structure across the catalog** rather than a strong concentration on a few items | Maintain a broad product portfolio while identifying high-performing segments for optimization |

| 3 | The **At Risk** segment represents a significant and recoverable revenue pool | Launch targeted re-engagement campaigns to reduce churn |

| 4 | High-value customers concentrate purchases over time | Personalize offers and retention strategies for top RFM segments |
